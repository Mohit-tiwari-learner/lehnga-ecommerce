    ...
    <div className="w-full bg-white min-h-screen pt-10 pb-20 px-4 lg:px-8 font-sans">
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="prose prose-sm md:prose-base max-w-none text-gray-600 leading-relaxed">
          <p>We want you to love your Nakhrali purchase. If for any reason you are not completely satisfied, we offer a straightforward return and exchange policy.</p>
          ...
          <p>Please email our support team at <strong>care@nakhrali.com</strong> within 48 hours of receiving your order. Include your order number and images of the product if there is a defect. Our team will guide you through the return process.</p>
